...
export const emailProviders: EmailProvider[] = [
  {
    ...
    smtp_port: 587,
    use_tls: true,
    description: 'Für Gmail benötigen Sie ein App-Passwort (nicht Ihr normales Passwort).',
    steps: [
  ...
  },
  {
    ...
    smtp_port: 587,
    use_tls: true,
    description: 'GMX erfordert die Aktivierung von externen Apps in den Einstellungen.',
    steps: [
  ...
  },
  {
    ...
    smtp_port: 587,
    use_tls: true,
    description: 'WEB.DE benötigt aktivierte externe App-Zugriffe.',
    steps: [
